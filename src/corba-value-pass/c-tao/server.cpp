...
int main (int iArgC, char *apArgV []) {
    try {
        ...
        // Register factory for the bundle type.

        AValueBundleFactory *pFactory = new AValueBundleFactory ();
        vORB->register_value_factory (CORBA::string_dup ("IDL:AValueBundle:1.0"), pFactory);
