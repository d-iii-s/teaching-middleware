    ...
    public static void main (String [] sArgs) {
        try {
            ...
            try (JMSContext context = connectionFactory.createContext ()) {
                ...
                // Set client identity for durable subscription.
                context.setClientID ("SomeClientName");
                ...
                try (JMSConsumer consumer = context.createDurableConsumer (topic, "SomeSubscriptionName")) {
                    while (true) {
